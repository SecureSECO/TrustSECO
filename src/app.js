...
var koa_send_1 = require("koa-send");
var cors_1 = require("@koa/cors");
var koa_body_1 = require("koa-body");
var koa_websocket_1 = require("koa-websocket");
var api_1 = require("./api");
var websocket_1 = require("./websocket");
var setup_1 = require("./setup");
(0, setup_1["default"])();
var app = (0, koa_websocket_1["default"])(new koa_1["default"]());
app.use((0, cors_1["default"])()).use((0, koa_body_1["default"])());
// Api Routes
app.use(api_1["default"].routes()).use(api_1["default"].allowedMethods());
// Websocket routes
app.ws.use(websocket_1["default"].routes()).use(websocket_1["default"].allowedMethods());
// Portal serving
...
app.use(function (ctx, next) { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/, (0, koa_send_1["default"])(ctx, 'public/index.html')];
}); }); });
app.listen(3000);
